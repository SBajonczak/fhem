...
#endif
    if (items < 2 || items > 3)
       croak_xs_usage(cv,  "sock, mcast_group, interface_addr=\"\"");
...
XS(boot_IO__Socket__Multicast)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXSproto_portable("IO::Socket::Multicast::_mcast_add", XS_IO__Socket__Multicast__mcast_add, file, "$$;$");
        (void)newXSproto_portable("IO::Socket::Multicast::_mcast_drop", XS_IO__Socket__Multicast__mcast_drop, file, "$$;$");
        (void)newXSproto_portable("IO::Socket::Multicast::mcast_loopback", XS_IO__Socket__Multicast_mcast_loopback, file, "$;$");
        (void)newXSproto_portable("IO::Socket::Multicast::mcast_ttl", XS_IO__Socket__Multicast_mcast_ttl, file, "$;$");
        (void)newXSproto_portable("IO::Socket::Multicast::_mcast_if", XS_IO__Socket__Multicast__mcast_if, file, "$;$");
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
